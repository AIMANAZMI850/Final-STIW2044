...
import 'package:mytutor1/views/paymentscreen.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  void _loadCart() {
    http.post(Uri.parse(Config.server + "/mytutor/Users/php/load_cart.php"),
        body: {
      ...
      if (response.statusCode == 200 && jsondata['status'] == 'success') {
        ...
        if (extractdata['cart'] != null) {
          ...
          titlecenter = qty.toString() + " subject in your cart";
          setState(() {});
        }
      } else {
  ...
  void _updateCart(int index, String s) {
    ...
    http.post(
        Uri.parse(Config.server + "/mytutor/Users/php/update_cartqty.php"),
        body: {'cart_id': cartList[index].cartid, 'operation': s}).timeout(
      const Duration(seconds: 5),
      onTimeout: () {
        return http.Response(
            'Error', 408); // Request Timeout response status code
  ...
  void _deleteItem(int index) {
    http.post(
        Uri.parse(Config.server + "/mytutor/Users/php/delete_cartqty.php"),
        body: {
          'user_email': widget.user.email,
